		...
		<div id="main">
			<div class="inner">
				<header>
					...
					<p>진행중인 경매 목록입니다. <br/> ** 기사분이 올린 경매는 저가 경매로 이루어집니다.(역경매) **</p>
				</header>
			<section class="tiles">
				<article class="style1">
					<span class="image"> <img src="images/pic1.png" />
						...
						<div class="content">
							<p>
								고양 이케아 > 경기도 의정부 민락동 가능한 기사 분 찾습니다. <br /> 물건 규격: 1.4 x 1.0m, 약 9kg
							</p>
						</div>
				...
				<article class="style7">
					<span class="image"> <img src="images/pic2.png" alt="" />
						...
						<div class="content">
							<p>
								광명 이케아(IKEA) > 서울시 성북구 월곡동 가능한 기사분 찾습니다. <br /> 물건 규격: 170cm x 89cm, 약 12kg
							</p>
						</div>
					</a> <br /> 남은기간: 00일 00시 00분 00초
					<div class="col-6 col-12-medium">
