		...
		<div class="col-sm-6 col-md-offset-3">
			<form action="user/newUserSubmitted.do" method="post">
				...
				<div class="form-group">
					...
					<input type="button"  class="button small" onclick="sample2_execDaumPostcode()"
				...
				<div class="form-group">
					<label for="favoriteUser" style="font-size: 24px">Favorite User</label>
					<input type="text" style="width: 800px" class="form-control"
						name="favoriteUser" placeholder="선호하는 매장을 입력하세요.">
				</div>
				<div class="form-group">
					<label for="languagePrefernce" style="font-size: 24px">Language Setting</label>
					<input type="text" style="width: 800px" class="form-control"
						name="languagePreference" placeholder="Korean">
				</div>
				<div class="form-group">
					<label for="carInfo" style="font-size: 24px">Car Information</label> <input
						type="text" style="width: 800px" class="form-control"
