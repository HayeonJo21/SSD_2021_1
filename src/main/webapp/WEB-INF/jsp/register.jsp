			...
			<div class="inner">
					...
					<label for="password2" style="font-size: 24px">Password
						...
						<div class="form-group">
							...
							<input type="button" class="button small"
								onclick="sample2_execDaumPostcode()" value="우편번호 찾기" name="postcode"> <br>
							<input type="text" id="sample2_address" placeholder="주소" name="address2">
							<br> <input type="text" id="sample2_detailAddress"
								placeholder="상세주소" name="detailAddress"> <input type="text"
								id="sample2_extraAddress" placeholder="참고항목" name="extraAddress">
				...
				<div class="form-group">
					<label for="favoriteUser" style="font-size: 24px">Favorite
						...
						name="favoriteUser" value="${userSession.favoriteUser}"
						placeholder="선호하는 매장을 입력하세요.">
				</div>
				<div class="form-group">
					<label for="languagePrefernce" style="font-size: 24px">Language
						...
						value="${userSession.languagePreference}" placeholder="Korean">
				</div>
				<div class="form-group">
